...
import type { ArchiveStore, NetMockContextHooks } from "./mock.js";
import type { HARArchive } from "./spec.js";
...
/**
 * Creates and returns a BatchInterceptor appropriate for the current environment (browser or
 * Node.js).
 *
 * This function dynamically imports the correct set of interceptors based on the detected global
 * environment. - In a browser environment (`globalThis.window` is defined), it attempts to import
 * browser interceptors. - In a Node.js environment (`globalThis.process` is defined), it imports
